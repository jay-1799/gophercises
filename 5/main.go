...
import (
	...
	link "github.com/jay-1799/gophercises/4"
)
...
//filter out any links with diff domain
...
func main() {
	urlFlag := flag.String("url", "https://jaypatel.link", "the url that you want to build  a sitemap for")
